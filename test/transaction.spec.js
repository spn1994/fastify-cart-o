...
//possoc riar quantas categoris quiser
const vitest_1 = require("vitest");
const node_child_process_1 = require("node:child_process");
//essa foi feita em javascript
const supertest_1 = __importDefault(require("supertest"));
const app_1 = require("../src/app");
(0, vitest_1.describe)('Transactions routes', () => {
    //executa antes q tudo executem, executa uma unica vez
    (0, vitest_1.beforeAll)(async () => {
        await app_1.app.ready();
    });
    //depois q executam eles fecham (vem do vitest)
    (0, vitest_1.afterAll)(async () => {
        await app_1.app.close();
    });
    //antes de cada um dos testes, nodechild process
